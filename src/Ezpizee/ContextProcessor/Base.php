...
abstract class Base
{
  ...
  public final function setContextDebug(array $debug): void {$this->context['debug']=$debug;}
  ...
  public final function getContextDebug(): array {return empty($this->context['debug']) ? [] : $this->context['debug'];}
}
